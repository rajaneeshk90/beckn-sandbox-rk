...
export class AmbulanceService implements DHPApiInterface {
    ...
    processResponse(response: typeof searchResponse | typeof selectResponse | 
        typeof initResponse | typeof confirmResponse | typeof statusResonse | 
        typeof updateResponse | typeof trackResponse | typeof supportResponse |
        typeof cancelResponse, request: DHPRequestDto ) {
